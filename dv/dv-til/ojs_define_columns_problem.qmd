...
I came across a puzzling problem using ObservableJS in a Quarto website. In OJS you can use "columns" (like R names()) to get the names of variables in a data object. Sometimes I need to get the names to reuse (eg in columns of Inputs.table or functions). 
