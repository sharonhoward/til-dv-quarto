...
Also, sometimes you want to find/get rid of rows in which *all* of a specific subset of columns are NAs.
...
## added: find/remove rows if some variables are *all* NA

[TODO: a working code example]

-   filter(if_all([tidy-select columns], ~is.na(.x))) |>
